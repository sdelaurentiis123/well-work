...
\begin{figure}[t]
  ...
  \caption{Per-trajectory VRMSE traces, overlaid across all four configurations on a single log-$y$ panel. Method is encoded by color/line style (legend); thin traces are individual trajectories and the thicker line of each color is the across-trajectory median. Walrus's divergence is structural across all trajectories rather than outlier-driven.}
  \label{fig:per-traj}
\end{figure}
